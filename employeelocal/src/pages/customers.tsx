...
export default function Customers() {
  ...
  const fetchCustomers = async () => {
    setLoading(true);
    try {
      const res = await fetch(`${API_BASE_URL}/api/customers/public`, { method: "GET" });
  ...
  const handleCreateCustomer = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`${API_BASE_URL}/admin/api/customers`, {
        method: "POST",
  ...
  const handleUpdateCustomer = async (updated: Customer) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`${API_BASE_URL}/admin/api/customers/${updated.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
